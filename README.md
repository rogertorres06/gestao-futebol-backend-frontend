...
* **Frontend:** React, TypeScript, Vite, Tailwind CSS, formatação monetária com `Intl.NumberFormat` e feedback em tempo real via Toast.
* **Ferramentas de Desenvolvimento:** IntelliJ IDEA e Git/GitHub.

## ✨ Funcionalidades Principais

* Registo e atualização dinâmica de equipas (Nome, Estádio, Divisão, Posição na Tabela e Orçamento).
* Gestão e contratação de jogadores associados às respetivas equipas.
